...
namespace dotnetcoreHW.Migrations
{
    ...
    [Migration("20200813162447_add_DateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.Course", b =>
                {
                    b.HasOne("dotnetcoreHW.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.CourseInstructor", b =>
                {
                    b.HasOne("dotnetcoreHW.Models.Course", "Course")
                    ...
                    b.HasOne("dotnetcoreHW.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("dotnetcoreHW.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("dotnetcoreHW.Models.OfficeAssignment", b =>
                {
                    b.HasOne("dotnetcoreHW.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("dotnetcoreHW.Models.OfficeAssignment", "InstructorId")
