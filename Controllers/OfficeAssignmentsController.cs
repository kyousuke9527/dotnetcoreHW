...
namespace dotnetcoreHW.Controllers
{
    ...
    public class OfficeAssignmentsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<OfficeAssignment>>> Get()
        {
        ...
        public async Task<ActionResult<OfficeAssignment>> Get(int id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesDefaultResponseType]
        public async Task<IActionResult> Put(int id, OfficeAssignment officeAssignment)
        {
        ...
        [ProducesDefaultResponseType]
        public async Task<ActionResult<OfficeAssignment>> Post(OfficeAssignment officeAssignment)
        {
            ...
            return CreatedAtAction("Get", new { id = officeAssignment.InstructorId }, officeAssignment);
        }
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesDefaultResponseType]
        public async Task<ActionResult<OfficeAssignment>> Delete(int id)
        {
            var officeAssignment = await _context.OfficeAssignment.FindAsync(id);
            if (officeAssignment == null)
            {
