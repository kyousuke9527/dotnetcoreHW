...
namespace dotnetcoreHW.Controllers
{
    ...
    public class CourseInstructorsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<CourseInstructor>>> Get()
        {
        ...
        public async Task<ActionResult<CourseInstructor>> Get(int id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesDefaultResponseType]
        public async Task<IActionResult> Put(int id, CourseInstructor courseInstructor)
        {
        ...
        [ProducesDefaultResponseType]
        public async Task<ActionResult<CourseInstructor>> Post(CourseInstructor courseInstructor)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesDefaultResponseType]
        public async Task<ActionResult<CourseInstructor>> Delete(int id)
        {
            var courseInstructor = await _context.CourseInstructor.FindAsync(id);
            if (courseInstructor == null)
            {
